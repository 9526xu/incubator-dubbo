...
public abstract class FailbackRegistry extends AbstractRegistry {
    ...
    public void register(URL url) {
        ...
        try {
            ...
            if (check || skipFailback) {
                ...
                throw new IllegalStateException("Failed to register " + url + " to registry " + getUrl().getAddress() + ", cause: " + t
                        .getMessage(), t);
            } else {
    ...
    public void reExportRegister(URL url) {
        ...
        try {
            ...
            if (!(e instanceof SkipFailbackWrapperException)) {
                throw new IllegalStateException("Failed to register (re-export) " + url + " to registry " + getUrl().getAddress() + ", cause: " + e
                        .getMessage(), e);
            }
        }
    }
    ...
    public void unregister(URL url) {
        ...
        try {
            ...
            if (check || skipFailback) {
                ...
                throw new IllegalStateException("Failed to unregister " + url + " to registry " + getUrl().getAddress() + ", cause: " + t
                        .getMessage(), t);
            } else {
    ...
    public void reExportUnregister(URL url) {
        ...
        try {
            ...
            if (!(e instanceof SkipFailbackWrapperException)) {
                throw new IllegalStateException("Failed to unregister(re-export) " + url + " to registry " + getUrl().getAddress() + ", cause: " + e
                        .getMessage(), e);
            }
        }
    }
    ...
    public void subscribe(URL url, NotifyListener listener) {
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(urls)) {
                ...
                logger.error("Failed to subscribe " + url + ", Using cached list: " + urls + " from cache file: " + getUrl()
                        .getParameter(FILE_KEY, System.getProperty("user.home") + "/dubbo-registry-" + url.getHost() + ".cache") + ", cause: " + t
                        .getMessage(), t);
            } else {
                // If the startup detection is opened, the Exception is thrown directly.
                boolean check = getUrl().getParameter(Constants.CHECK_KEY, true)
    ...
    public void unsubscribe(URL url, NotifyListener listener) {
        ...
        try {
            ...
            if (check || skipFailback) {
                ...
                throw new IllegalStateException("Failed to unsubscribe " + url + " to registry " + getUrl().getAddress() + ", cause: " + t
                        .getMessage(), t);
            } else {
